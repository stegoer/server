...
var (
	// ImageOrderFieldCreatedAt orders Image by created_at.
	ImageOrderFieldCreatedAt = &ImageOrderField{
		field: image.FieldCreatedAt,
	...
	// ImageOrderFieldUpdatedAt orders Image by updated_at.
	ImageOrderFieldUpdatedAt = &ImageOrderField{
		field: image.FieldUpdatedAt,
		toCursor: func(i *Image) Cursor {
			return Cursor{
				ID:    i.ID,
				Value: i.UpdatedAt,
