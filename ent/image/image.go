...
const (
	...
	ChannelRED_GREEN      Channel = "RED_GREEN"
	ChannelRED_BLUE       Channel = "RED_BLUE"
	ChannelGREEN_BLUE     Channel = "GREEN_BLUE"
	ChannelRED_GREEN_BLUE Channel = "RED_GREEN_BLUE"
)
...
func ChannelValidator(c Channel) error {
	switch c {
	case ChannelRED, ChannelGREEN, ChannelBLUE, ChannelRED_GREEN, ChannelRED_BLUE, ChannelGREEN_BLUE, ChannelRED_GREEN_BLUE:
		return nil
	default:
